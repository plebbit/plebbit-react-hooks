...
exports.flattenCommentsPages = void 0;
...
const flattenCommentsPages = (pageInstanceOrPagesInstance) => {
    var _a, _b, _c, _d, _e;
    ...
    for (const comment of (pageInstanceOrPagesInstance === null || pageInstanceOrPagesInstance === void 0 ? void 0 : pageInstanceOrPagesInstance.comments) || []) {
        ...
        for (const sortType of sortTypes) {
            if ((_b = (_a = comment === null || comment === void 0 ? void 0 : comment.replies) === null || _a === void 0 ? void 0 : _a.pages) === null || _b === void 0 ? void 0 : _b[sortType]) {
                flattenedComments.push(...(0, exports.flattenCommentsPages)((_d = (_c = comment.replies) === null || _c === void 0 ? void 0 : _c.pages) === null || _d === void 0 ? void 0 : _d[sortType]));
            }
        }
    }
    ...
    for (const sortType of sortTypes) {
        if ((_e = pageInstanceOrPagesInstance === null || pageInstanceOrPagesInstance === void 0 ? void 0 : pageInstanceOrPagesInstance.pages) === null || _e === void 0 ? void 0 : _e[sortType]) {
            flattenedComments.push(...(0, exports.flattenCommentsPages)(pageInstanceOrPagesInstance.pages[sortType]));
        }
    }
    ...
    for (const sortType of sortTypes) {
        if (pageInstanceOrPagesInstance === null || pageInstanceOrPagesInstance === void 0 ? void 0 : pageInstanceOrPagesInstance[sortType]) {
            flattenedComments.push(...(0, exports.flattenCommentsPages)(pageInstanceOrPagesInstance[sortType]));
        }
    }
...
exports.flattenCommentsPages = flattenCommentsPages;
const utils = {
    merge,
    clone,
    flattenCommentsPages: exports.flattenCommentsPages,
};
