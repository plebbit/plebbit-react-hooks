...
import { PlebbitProvider, useAccount, useAccounts, useAccountsActions, useAccountComments, useAccountVotes, useAccountVote, useComment, useAccountNotifications, useFeed } from '../index';
...
describe('accounts', () => {
    ...
    describe('no accounts in database', () => {
        ...
        test('create new accounts', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const rendered2 = renderHook((accountName) => useAccount(accountName), { wrapper: PlebbitProvider });
    ...
    describe('multiple accounts in database', () => {
        ...
        test('change which account is active', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            expect(rendered.result.current.account.name).toBe('custom name');
            // render second context with empty state to check if accounts saved to database
            const rendered2 = renderHook(() => useAccount(), { wrapper: PlebbitProvider });
            // accounts not yet loaded from database
            expect(rendered2.result.current).toBe(undefined);
            try {
                yield rendered2.waitForNextUpdate();
        ...
        test('edit non active account display name', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const rendered2 = renderHook(() => useAccount('Account 2'), { wrapper: PlebbitProvider });
            // accounts not yet loaded from database
            expect(rendered2.result.current).toBe(undefined);
            try {
                yield rendered2.waitForNextUpdate();
        ...
        test(`change account order`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const rendered2 = renderHook(() => useAccounts(), { wrapper: PlebbitProvider });
            try {
                yield rendered2.waitForNextUpdate();
            }
            catch (e) {
    ...
    describe('multiple comments and votes in database', () => {
        ...
        beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            rendered = renderHook((props) => {
                ...
                const account = useAccount(props === null || props === void 0 ? void 0 : props.accountName);
                const accountsActions = useAccountsActions();
                ...
                const accountVote = useAccountVote(props === null || props === void 0 ? void 0 : props.commentCid, props === null || props === void 0 ? void 0 : props.accountName);
        ...
        test(`get account comment and add cid to it when receive challengeVerification`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const rendered2 = renderHook(() => useAccountComments(), { wrapper: PlebbitProvider });
            try {
                yield rendered2.waitForNextUpdate();
            }
            catch (e) {
        ...
        test(`cid gets added to account comment after fetched in useComment`, () => __awaiter(void 0, void 0, void 0, function* () {
            const rendered = renderHook((commentCid) => {
        ...
        test(`cid gets added to account comment after feed is fetched`, () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const rendered = renderHook((props) => {
                const { feed } = useFeed(props === null || props === void 0 ? void 0 : props.subplebbitAddresses, 'new');
                const accountComments = useAccountComments();
            ...
            Subplebbit.prototype.getSortedPosts = () => __awaiter(void 0, void 0, void 0, function* () {
                return ({
                    comments: [{
                            cid: 'cid from feed',
        ...
        test(`account votes are stored to database`, () => __awaiter(void 0, void 0, void 0, function* () {
            // render with new context to see if still in database
            const rendered2 = renderHook(() => useAccountVotes(), { wrapper: PlebbitProvider });
            try {
                yield rendered2.waitForNextUpdate();
            }
            catch (e) {
    ...
    describe('one comment in database', () => {
        ...
        beforeEach(() => __awaiter(void 0, void 0, void 0, function* () {
            ...
            rendered = renderHook((props) => {
                const account = useAccount(props === null || props === void 0 ? void 0 : props.accountName);
                const { notifications, markAsRead } = useAccountNotifications(props === null || props === void 0 ? void 0 : props.accountName);
        ...
        test('get notifications', () => __awaiter(void 0, void 0, void 0, function* () {
            ...
            const rendered2 = renderHook(() => useAccountNotifications(), { wrapper: PlebbitProvider });
            try {
