...
#### Feeds Hooks
```
useFeed({subplebbitAddresses: string[], sortType?: string, postsPerPage?: number, filter: CommentsFilter, newerThan: number}): {feed: Feed, loadMore: function, hasMore: boolean}
